            ...
            <div class="container-fluid">
                <div role="main" class="container">
                    ...
                    <form action="../../Controllers/" method="post">
                        ...
                        <div class="card"  style='background-color: rgba(06 ,44,51,0.85);'>
                            <div class="card-body">
                                ...
                                <div class="form-group row gutters">
                                    ...
                                    <div class="col-sm-10" style="margin-bottom: 10px">
                                        <input class="form-control" type="text" name="study_year" value="" required>
                                    </div>

                                    <label for="course_degree" class="col-sm-2 col-form-label" style="color: white;">Max Degree</label>
                                    <div class="col-sm-10">
                                        <input class="form-control" type="text" name="max_degree" value="" required>
                                    </div>  

                                    <label for="course_description" class="col-sm-2 col-form-label" style="color: white;margin-top: 15px;">Description</label>
                                    <div class="col-sm-10" style="margin-top: 15px;">
                                        <textarea class="form-control"  name="description" rows="8" cols="30" required></textarea>
                                    </div>  
                                </div>
