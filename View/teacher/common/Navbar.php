<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
    ...
    <ul class="navbar-nav ml-auto">
        <li class="nav-item dropdown no-arrow">
            ...
            <button class="btn Navbtn dropdown-toggle" id="userDropdown"  type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="../../Images/User.png" class="rounded-circle" alt="User Img" width="30px" height="30px">&nbsp; &nbsp; Teacher Name</button>

            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">
                <a class="dropdown-item" href="./home.php"><i class="fas fa-home"></i>&nbsp; &nbsp; Home</a>
                <div class="dropdown-divider"></div>
                <a class="dropdown-item" href="./Courses.php"><i class="fas fa-book-open"></i>&nbsp; &nbsp; Courses</a>
                <a class="dropdown-item" href="./students.php"><i class="fas fa-user-graduate"></i>&nbsp; &nbsp; Students</a>
...
<div id="wrapper">
    <div id="sidebar-wrapper">
        <ul class="sidebar-nav">
            ...
            <li>
                <a href="./time_table.php"><i class="far fa-calendar-times"></i>&nbsp; &nbsp; Time Table</a>
            </li>
