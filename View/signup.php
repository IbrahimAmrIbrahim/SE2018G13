                                        ...
                                        <div class="col-md-9">
                                            <div class="input-group mb-3">
                                                ...
                                                <div class="input-group-append">
                                                    <button class="btn btn-info" type="button" onmousedown="showPassword()" onmouseup="showPassword()"><i class="fas fa-eye"></i></button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>  
                                    ...
                                    <div class="row"  style="padding-top: 16px">
                                        ...
                                        <div class="col-md-9">
                                            <div class="input-group mb-3">
                                                ...
                                                <div class="input-group-append">
                                                    <button class="btn btn-info" type="button" onmousedown="showPin()" onmouseup="showPin()"><i class="fas fa-eye"></i></button>
                                                </div>
                                            </div>
                                        </div>
                                    </div> 
