<?php
include_once('../teacher/controllers/common.php');
include_once('../teacher/components/head.php');
include_once('../teacher/models/Courses.php');
include_once('../teacher/models/grade.php');
Database::DBConnect();
?>
